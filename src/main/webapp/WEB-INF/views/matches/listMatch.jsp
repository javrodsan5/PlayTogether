	...
	<body>
				...
				<tbody>
					<c:forEach items="${matches}" var="match">
						<tr class="rowtable">
							...
							<td><spring:url
									value="/sports/{deporte}/championships/{championshipId}/match/{matchId}/result/{team}?search=Antonio"
									var="result2Url">
								...
								<div class="botoncitores1">
									<a href="${fn:escapeXml(result2Url)}">Añadir resultados de
										Equipo 1</a>
								</div> <spring:url
									value="/sports/{deporte}/championships/{championshipId}/match/{matchId}/result/{team}?search=Antonio"
									var="result2Url">
		...
		<c:if test="${crearPartido==true}">
			...
			<div class="botoncitocrear">
				<a id="createMatch" href="${fn:escapeXml(dateUrl)}">Añadir
					partido</a>
			</div>
		</c:if>
